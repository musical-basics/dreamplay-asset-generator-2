...
export const AI_ZONES: {
    ...
    { label: 'Center Dial', emoji: '⭕', rect: [0.42, 0.30, 0.18, 0.28], hint: 'Fix center dial: alternating rubber arc segments around perimeter with a metallic accent band — match the reference image for exact colors' },
    { label: 'Buttons', emoji: '▦', rect: [0.62, 0.32, 0.20, 0.22], hint: 'Fix 6 rectangular rubber buttons (2×3 grid): 5 matte buttons and 1 accent button — match the reference image for exact colors' },
